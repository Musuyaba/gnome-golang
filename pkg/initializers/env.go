...
type Config struct {
	...
	DATABASE_MONGODB_HASH_NAME        string `mapstructure:"DATABASE_MONGODB_HASH_NAME"`
	DATABASE_MONGODB_DATA_NODE_A_NAME string `mapstructure:"DATABASE_MONGODB_DATA_NODE_A_NAME"`
	DATABASE_MONGODB_DATA_NODE_B_NAME string `mapstructure:"DATABASE_MONGODB_DATA_NODE_B_NAME"`
	DATABASE_MONGODB_HOST             string `mapstructure:"DATABASE_MONGODB_HOST"`
	DATABASE_MONGODB_USER             string `mapstructure:"DATABASE_MONGODB_USER"`
	DATABASE_MONGODB_PASSWORD         string `mapstructure:"DATABASE_MONGODB_PASSWORD"`
	DATABASE_MONGODB_PORT             string `mapstructure:"DATABASE_MONGODB_PORT"`
}
